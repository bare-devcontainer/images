...
| Tags | Debian variant |
|------|----------------|
| `0.12.11-trixie`, `0.12.11`, `trixie` | trixie |
| `0.12.11-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `0.12.11-trixie-<YYYYMMDD>`).
<!-- tags:end -->
