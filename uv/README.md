...
| Tags | Debian variant |
|------|----------------|
| `0.11.29-trixie`, `0.11.29`, `trixie` | trixie |
| `0.11.29-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `0.11.29-trixie-<YYYYMMDD>`).
<!-- tags:end -->
