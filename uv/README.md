...
| Tags | Debian variant |
|------|----------------|
| `0.12.6-trixie`, `0.12.6`, `trixie` | trixie |
| `0.12.6-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `0.12.6-trixie-<YYYYMMDD>`).
<!-- tags:end -->
