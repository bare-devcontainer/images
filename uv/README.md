...
| Tags | Debian variant |
|------|----------------|
| `0.12.8-trixie`, `0.12.8`, `trixie` | trixie |
| `0.12.8-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `0.12.8-trixie-<YYYYMMDD>`).
<!-- tags:end -->
