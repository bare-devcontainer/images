...
| Tags | Debian variant |
|------|----------------|
| `12.4.2-trixie`, `12-trixie`, `12.4.2`, `12`, `trixie` | trixie |
| `12.4.2-bookworm`, `12-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `12.4.2-trixie-<YYYYMMDD>`).
<!-- tags:end -->
