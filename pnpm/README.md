...
| Tags | Debian variant |
|------|----------------|
| `12.6.0-trixie`, `12-trixie`, `12.6.0`, `12`, `trixie` | trixie |
| `12.6.0-bookworm`, `12-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `12.6.0-trixie-<YYYYMMDD>`).
<!-- tags:end -->
