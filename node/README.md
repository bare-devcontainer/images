...
|-----|-----------------|---------------|
| <!-- renovate: datasource=node-version depName=node versioning=node -->`26.5.0-trixie`, `26-trixie`, <!-- renovate: datasource=node-version depName=node versioning=node -->`26.5.0`, `26`, `trixie` | 26.x (Current) | trixie |
| <!-- renovate: datasource=node-version depName=node versioning=node -->`26.5.0-bookworm`, `26-bookworm`, `bookworm` | 26.x (Current) | bookworm |
| <!-- renovate: datasource=node-version depName=node versioning=node -->`24.18.0-trixie`, `24-trixie`, <!-- renovate: datasource=node-version depName=node versioning=node -->`24.18.0`, `24` | 24.x (LTS) | trixie |
| <!-- renovate: datasource=node-version depName=node versioning=node -->`24.18.0-bookworm`, `24-bookworm` | 24.x (LTS) | bookworm |
