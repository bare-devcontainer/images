...
environment small and auditable: it carries only what Terraform development needs, installs
...
| Tags | Debian variant |
|------|----------------|
| `1.16.1-trixie`, `1-trixie`, `1.16.1`, `1`, `trixie` | trixie |
| `1.16.1-bookworm`, `1-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `1.16.1-trixie-<YYYYMMDD>`).
<!-- tags:end -->
...
an image pulled from `docker.io/baredevcontainer/terraform` verifies with the same command
