...
| Tags | Debian variant |
|------|----------------|
| `1.16.2-trixie`, `1-trixie`, `1.16.2`, `1`, `trixie` | trixie |
| `1.16.2-bookworm`, `1-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `1.16.2-trixie-<YYYYMMDD>`).
<!-- tags:end -->
