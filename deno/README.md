...
| Tags | Debian variant |
|------|----------------|
| `2.9.3-trixie`, `2-trixie`, `trixie`, `2.9.3`, `2` | trixie |
| `2.9.3-bookworm`, `2-bookworm`, `bookworm` | bookworm |

Tags are also published with a date suffix on each build (e.g., `2.9.3-trixie-<YYYYMMDD>`).
<!-- tags:end -->
